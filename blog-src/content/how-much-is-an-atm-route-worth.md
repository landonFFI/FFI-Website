...
meta_description: "How much is your ATM route worth? See how buyers value routes, what public listings show, what raises or lowers your price, and how to prepare to sell."
primary_keyword: "how much is an ATM route worth"
secondary_keywords:
  - "sell ATM route"
  - "ATM route valuation"
  - "sell ATM route Alabama"
  - "ATM business for sale value"
  - "buy ATM route Alabama"
  - "ATM portfolio valuation"
h1: "How Much Is an ATM Route Worth? How Buyers Value It, and How to Get a Better Offer"
dek: "Your route's value isn't the machines. It's the income they produce and how safe that income looks to a buyer. Here's how the math works."
short_answer: "Most ATM routes are valued on the yearly profit they produce, not the price of the machines. Public listings commonly ask about 2.5 to 4 times a route's yearly cash flow, though small routes often sell for less and final prices vary. Signed location agreements, clean records, and newer machines raise value."
diagnosis:
  audience: "Independent ATM operators and route owners (often small, 1-50 machines) thinking about selling."
  outcome: "Call FFI for an offer."
  barrier: "Trust. Fear of being lowballed by an insider; uncertainty about value."
cta:
  service_url: "../atm-route-acquisition.html"
  service_label: "our ATM route buying program"
  headline: "Thinking About Selling Your Route?"
  body: "We buy ATM routes and single machines in Alabama. Quick decisions, cash offers, any number of machines. Tell us what you have."
  button: "Get an Offer on My Route"
  form_subject: "Blog Lead: How Much Is My ATM Route Worth"
related:
  - questions-to-ask-atm-placement-company
  - how-much-does-an-atm-cost
  - att-copper-landline-shutdown-atm
faq:
  - q: "How much is an ATM route worth?"
    a: "Most routes are valued on their yearly cash flow. Public listings commonly ask about 2.5 to 4 times yearly cash flow, but asking prices aren't sale prices, and small routes often sell for less. Location agreements, records, and machine condition all move the number."
  - q: "Are the ATM machines themselves worth much when selling a route?"
    a: "Usually less than owners expect. Buyers often value used machines at low wholesale prices. The value is in the locations and the income they produce, especially when the location agreements can be transferred to the buyer."
  - q: "What records do I need to sell my ATM route?"
    a: "Twelve to 24 months of processor statements for each machine, copies of every location agreement, the make, model, and age of each machine, how each machine connects, and what you pay each location."
  - q: "What lowers the value of an ATM route?"
    a: "Location agreements that can't be transferred or are close to ending, old machines that will need replacing, one location producing most of the income, falling transaction counts, and messy or missing records."
  - q: "Can I sell just one ATM?"
    a: "Yes. Ford Frontier Investments buys single machines as well as full routes, from business owners and operators."
  - q: "How fast can I sell my ATM route?"
    a: "It depends on the size of the route and how organized your records are. We make quick decisions and pay cash, and good records speed everything up."
sources:
  - title: "Valuing ATM portfolios"
    publisher: "ATM Marketplace"
    url: "https://www.atmmarketplace.com/news/valuing-atm-portfolios/"
    date: "March 21, 2002"
  - title: "ATM route listings reviewed (routes and established businesses for sale)"
    publisher: "BizBuySell"
    url: "https://www.bizbuysell.com/routes-established-businesses-for-sale/21/"
...
1. **Asking prices aren't sale prices.** Sellers list high. Final prices are often lower.
2. **"Cash flow" isn't measured the same way by every seller.** Some count their own time and loading costs. Some don't. Two routes with the same "cash flow" can be worth very different amounts.
...
- **Wireless connections.** Machines on phone lines carry extra risk, especially with AT&T retiring copper lines in parts of Alabama. See [is your ATM still on a phone line?](att-copper-landline-shutdown-atm.html)
...
1. **Processor statements** for every machine, 12 to 24 months back.
2. **Every location agreement,** with start dates, end dates, and what each one says about transfer.
3. **A machine list** with the make, model, age, and how each one connects.
4. **What you pay each location,** per transaction or per month.
5. **Your costs:** cash loading, wireless, repairs, and anything else you pay to run the route.
6. **Notes on each location.** Busy seasons, relationships, anything a new owner should know.
...
We're Alabama-owned and based in Birmingham. Learn more about [selling your ATM route](../atm-route-acquisition.html) or [selling a single ATM](../sell-your-atm.html).
