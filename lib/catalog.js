...
export const ATM_CATALOG = {
  'halo-ii': {
    ...
    optionGroups: [lockGroup(350), keypadGroup, hyosungTopperGroup, nfcGroup(460), ...SERVICE_GROUPS],
  },
  force: {
    ...
    optionGroups: [cardReaderGroup, lockGroup(350), hyosungTopperGroup, keypadGroup, cameraGroup, nfcGroup(460), ...SERVICE_GROUPS],
  },
  '2800t': {
