...
meta_description: "An ATM that keeps breaking or running out of cash costs more than lost fees. See the hidden costs, the 5 most common causes, and how to fix it."
primary_keyword: "ATM keeps breaking"
secondary_keywords:
  - "ATM out of order"
  - "ATM out of cash"
  - "ATM uptime"
  - "unreliable ATM company"
  - "ATM not working in my store"
  - "replace my ATM provider"
h1: "What an \"Out of Order\" ATM Really Costs Your Business"
dek: "The fees you lose on a dead ATM are the small part. The bigger cost is what it teaches your customers. Here's how to see the full cost, and how to stop paying it."
short_answer: "An out-of-order ATM costs you three ways: the fees you don't earn, the sales you lose when customers leave to find cash, and the trust you lose when customers stop counting on your machine. Most downtime comes from five causes: running out of cash, bad connections, jams, old equipment, and slow repairs."
diagnosis:
  audience: "Owners with an existing ATM that's unreliable, and owners who were burned by one before."
  outcome: "Contact FFI to replace or switch."
  barrier: "Endowment and inertia. They're used to the current setup and underestimate its cost."
cta:
  service_url: "../free-atm-placement.html"
  service_label: "free ATM placement"
  headline: "Tired of Apologizing for Your ATM?"
  body: "Tell us what's going on with your current machine. We'll tell you whether a free placement, a new machine, or a processing switch fixes it."
  button: "Fix My ATM Problem"
  form_subject: "Blog Lead: Out-of-Order ATM"
related:
  - questions-to-ask-atm-placement-company
  - att-copper-landline-shutdown-atm
  - how-free-atm-placement-works
faq:
  - q: "Why does my ATM keep running out of cash?"
    a: "Usually because nobody is watching the cash level between visits, or the refill schedule doesn't match how busy the machine is. Remote monitoring shows cash levels in real time, so loads can be scheduled before the machine runs dry."
  - q: "Why does my ATM keep saying it's out of service?"
    a: "The most common causes are a lost connection to the network, a bill jam, a paper or receipt printer problem, an empty cassette, or old parts that are wearing out. Many connection problems come from old phone lines."
  - q: "What is good ATM uptime?"
    a: "Uptime is the share of time the machine is working and able to hand out cash. Ask your provider for a documented number. Ford Frontier Investments runs at 98% uptime, documented in our remote monitoring system."
  - q: "Can I replace my ATM company if my machine is always broken?"
    a: "Often, yes. Check your current agreement for the term, renewal, and termination sections. We offer a new ATM to qualifying businesses with old, unreliable machines, and free processing for owners who want to switch."
  - q: "Does a broken ATM hurt my other sales?"
    a: "It can. Customers who need cash may leave to find it and spend it somewhere else. In one industry survey of in-store ATM users, 35% said they would shop at the store less often if the ATM were removed."
sources:
  - title: "Service Centre: One jam too far for Shahid's forecourts"
    publisher: "Forecourt Trader"
    url: "https://forecourttrader.co.uk/service-centre/service-centre-jac-roper-on-a-jamming-atm-chasing-money-and-a-bad-start/644600.article"
...
Many older ATMs still connect over a phone line. Phone lines drop, get noisy, and are being shut down in parts of Alabama. We explain that in [what AT&T's copper shutdown means for your ATM](att-copper-landline-shutdown-atm.html).
...
**If an ATM company owns it:** pull out your agreement and find the sections on the term, renewal, and termination. Note any notice deadlines. When the time is right, a [free placement](../free-atm-placement.html) with a company that tracks its uptime can replace it.

**If you own it:** you may not need a new machine. You may need a better connection and better processing. We offer [free ATM processing](../atm-processing.html) with 24/7 tech support, and we can [convert your machine to wireless](../wireless-atm.html).

**If you're done with it:** we buy ATMs. See [sell your ATM](../sell-your-atm.html).
