...
meta_description: "How much does a business make from an ATM? Learn the simple math, what drives transactions, how you get paid, and why no honest company quotes one split."
primary_keyword: "how much does a business make from an ATM"
secondary_keywords:
  - "ATM commission for store owner"
  - "how much money does an ATM make for a business"
  - "ATM revenue share"
  - "ATM surcharge split"
  - "is an ATM worth it for my business"
  - "free ATM placement earnings"
h1: "How Much Can Your Business Make From a Free ATM? The Honest Math"
dek: "You'll see big promises online. Here's how to estimate what an ATM will really do in your business, using your own numbers."
short_answer: "It depends on how many of your customers use the machine. A common industry rule of thumb is that 3% to 7% of a store's monthly customers will use an in-store ATM, and bars often run higher. Multiply your expected transactions by your share of each surcharge, and you have a realistic monthly estimate."
diagnosis:
  audience: "Owners weighing free placement who want to know if it's worth the floor space."
  outcome: "Request free placement to get a real, location-specific estimate."
  barrier: "Uncertainty plus suspicion that projections are inflated."
cta:
  service_url: "../free-atm-placement.html"
  service_label: "free ATM placement"
  headline: "Want a Real Estimate for Your Location?"
  body: "Every location is different, so we look at yours before we give you numbers. Tell us about your business and we'll walk you through what an ATM could realistically do there."
  button: "Get My Estimate"
  form_subject: "Blog Lead: How Much Can My Business Make"
related:
  - how-free-atm-placement-works
  - questions-to-ask-atm-placement-company
  - atm-out-of-order-cost
faq:
  - q: "How much money does an ATM make for a business?"
    a: "It depends on transaction volume and your share of each surcharge. A common rule of thumb is that 3% to 7% of a store's monthly customers use an in-store ATM. Multiply your expected transactions by your per-transaction share to estimate monthly earnings."
  - q: "What is a typical ATM revenue split for a store owner?"
    a: "There isn't one. Splits vary with transaction volume, location, and history. A trustworthy ATM company will show you your exact share in writing before the machine is installed."
  - q: "How do business owners get paid for an ATM?"
    a: "With Ford Frontier Investments, your share is deposited by ACH at the start of each month, straight from the payment networks. You also receive a monthly email statement showing transactions and earnings."
  - q: "What makes an ATM do more transactions?"
    a: "Cash-heavy customers, long or late hours, few nearby ATMs, a visible spot near the entrance or checkout, and a machine that is always full and working."
  - q: "Can an ATM help my business in other ways besides the fees?"
    a: "It can. Customers who get cash on-site can spend it with you instead of leaving to find an ATM. In one industry survey of in-store ATM users, 35% said they would shop at the store less often if the ATM were removed."
sources:
...
1. **Count your customers.** How many people walk in on a normal day? Your register count is a good start.
2. **Multiply by your days open.** That's your monthly customer count.
3. **Multiply by 3% for a low estimate and 7% for a high one.**
...
**The machine is always full and working.** This one matters more than people think. Every time a customer finds an "out of order" sign, they learn not to count on your ATM. Some of them stop trying. That's why we track our uptime. Our machines run at 98% uptime, documented in our remote monitoring system. For more on this, read [what an "out of order" ATM really costs you](atm-out-of-order-cost.html).
...
If your customers use cash and you have steady foot traffic, a [free ATM placement](../free-atm-placement.html) is usually worth the few square feet it takes. It costs you nothing, it earns you a share of every transaction, and it keeps customers from walking out to find cash somewhere else.
