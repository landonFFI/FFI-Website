...
export const PILLAR_PAGES = [
  ...
  },
  {
    ...
    faq: [
      ...
      ['Which brand is cheaper?', "Entry-level pricing is close between the two brands — Hyosung's Halo II currently starts slightly lower than Genmega's G2500, but the difference is minor compared to how cassette size and add-ons affect the final price."],
    ...
    sections: [
      {
        ...
        blocks: [
          ...
          '**Upfront cost:** new machines start at {from:halo-ii} and ship free within the continental US; used prices depend on the model and condition of what\'s in stock. **Warranty:** a new machine is covered by the manufacturer for two years, a used one for 90 days. **Compliance and processing:** identical either way — every machine we sell meets current EMV, ADA, and PCI standards and comes with free processing setup when you process with Ford Frontier Investments.',
        ],
      },
      {
