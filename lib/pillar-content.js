...
export const PILLAR_PAGES = [
  {
    ...
    faqSections: [
      ...
      },
      {
        ...
        items: [
          ['Is shipping really free?', 'Yes — every machine ships free nationwide, with no minimum order.'],
      ...
      },
      {
        ...
        items: [
          ...
          ["What's included with every purchase?", 'Every ATM bought from Ford Frontier Investments includes free 24/7 support, free transaction processing setup, no hidden fees, and a free programming sheet.'],
          ['Do I need technical experience to set up an ATM?', 'No — transaction processing setup is handled for you at no cost, and a programming sheet is included with every machine to guide the rest of the setup.'],
        ],
      },
      {
        ...
        items: [
          ...
          ['Do I have to use Ford Frontier Investments for processing?', 'Transaction processing setup is included free with your purchase and covers all major networks, but the machine is yours to operate as you choose.'],
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        blocks: ['Every machine needs to be connected to a transaction processor before it can dispense cash. This setup is included free with every machine purchased from Ford Frontier Investments — no separate processing contract to negotiate on your own.'],
      },
      {
  ...
  },
  {
    ...
    intro: 'Both new and used ATMs from Ford Frontier Investments include full transaction processing setup and are compliant with current EMV, ADA, and PCI standards — the real differences come down to upfront cost, warranty, and how long you plan to operate the machine.',
    sections: [
      {
        ...
        blocks: [
          {
            ...
            rows: [
              ...
              ['Processing setup', 'Included free', 'Included free'],
              ['Best for', 'Long-term operators', 'First-time buyers, testing a location'],
            ],
          },
          '**Upfront cost:** new machines start at {from:g2500} and ship free; used prices depend on the model and condition of what\'s in stock. **Warranty:** a new machine is covered by the manufacturer for two years, a used one for 90 days. **Compliance and processing:** identical either way — every machine we sell meets current EMV, ADA, and PCI standards and comes with free processing setup.',
        ],
      },
      {
      ...
      },
      {
        ...
        blocks: ["If you're testing a new location and aren't yet sure it'll perform well, or your upfront budget is tight, a used machine lowers the initial investment while still including the same free processing setup as a new one."],
      },
      {
